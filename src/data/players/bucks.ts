...
export const PLAYERS: Player[] = [
  ...
  { id: "sam-cassell-bucks-1990s", name: "Sam Cassell", franchiseId: "bucks", decade: "1990s", positions: ["PG"], stats: { pts: 18.5, reb: 3.5, ast: 7.0, stl: 1.0, blk: 0.2 }, years: "1998–1999", accolades: "Big-shot floor general" },
